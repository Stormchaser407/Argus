...
const IS_TEST = "PROD" === 'test';
const IS_PERF = "PROD" === 'perf';
const IS_BETA = "PROD" === 'staging';
const PAID_MESSAGES_PURPOSE = 'paid_messages';
const DEBUG = "PROD" !== 'production';
...
//# sourceMappingURL=src_config_ts-src_util_schedulers_ts.a3ed2e850035a884641e.js.map